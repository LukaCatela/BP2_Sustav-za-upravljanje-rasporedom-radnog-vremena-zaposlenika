...
CREATE TABLE smjene(
    id INT PRIMARY KEY AUTO_INCREMENT,
    vrsta_smjene ENUM('jutarnja', 'popodnevna', 'noćna') NOT NULL, -- 1 jutarnja, 2 popodnevna, 3 nocna
...
CREATE TABLE godisnji_odmori (
    ...
    status ENUM('odobren', 'odbijen', 'na čekanju', 'čeka prihvaćanje') DEFAULT 'na čekanju', 
