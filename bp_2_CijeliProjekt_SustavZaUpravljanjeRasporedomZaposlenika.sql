...
VALUES
-- Prosinac 2024
(1, '2024-12-01', '08:00:00', '16:00:00'), (2, '2024-12-01', '16:00:00', '24:00:00'),
(3, '2024-12-01', '08:00:00', '16:00:00'), (4, '2024-12-01', '16:00:00', '24:00:00'),
(5, '2024-12-01', '08:00:00', '16:00:00'), (6, '2024-12-02', '16:00:00', '24:00:00'),
(7, '2024-12-02', '08:00:00', '16:00:00'), (8, '2024-12-02', '16:00:00', '24:00:00'),
(9, '2024-12-02', '08:00:00', '16:00:00'), (10, '2024-12-02', '16:00:00', '24:00:00'),
(11, '2024-12-03', '08:00:00', '16:00:00'), (12, '2024-12-03', '16:00:00', '24:00:00'),
(13, '2024-12-03', '08:00:00', '16:00:00'), (14, '2024-12-03', '16:00:00', '24:00:00'),
(15, '2024-12-03', '08:00:00', '16:00:00'), (16, '2024-12-04', '16:00:00', '24:00:00'),
(17, '2024-12-04', '08:00:00', '16:00:00'), (18, '2024-12-04', '16:00:00', '24:00:00'),
(19, '2024-12-04', '08:00:00', '16:00:00'), (20, '2024-12-04', '16:00:00', '24:00:00'),
(21, '2024-12-05', '08:00:00', '16:00:00'), (22, '2024-12-05', '16:00:00', '24:00:00'),
(23, '2024-12-05', '08:00:00', '16:00:00'), (24, '2024-12-05', '16:00:00', '24:00:00'),
(25, '2024-12-05', '08:00:00', '16:00:00'),

-- Siječanj 2025
(1, '2025-01-01', '16:00:00', '24:00:00'), (2, '2025-01-01', '08:00:00', '16:00:00'),
(3, '2025-01-01', '16:00:00', '24:00:00'), (4, '2025-01-01', '08:00:00', '16:00:00'),
(5, '2025-01-01', '16:00:00', '24:00:00'), (6, '2025-01-02', '08:00:00', '16:00:00'),
(7, '2025-01-02', '16:00:00', '24:00:00'), (8, '2025-01-02', '08:00:00', '16:00:00'),
(9, '2025-01-02', '16:00:00', '24:00:00'), (10, '2025-01-02', '08:00:00', '16:00:00'),
(11, '2025-01-03', '16:00:00', '24:00:00'), (12, '2025-01-03', '08:00:00', '16:00:00'),
(13, '2025-01-03', '16:00:00', '24:00:00'), (14, '2025-01-03', '08:00:00', '16:00:00'),
(15, '2025-01-03', '16:00:00', '24:00:00');
...
-- 1. Pregled aktivnih zaposlenika s osnovnim informacijama
...
-- 2. Mjesečna placa po zaposleniku
...
-- 3. Aktivni projekti i zadaci

CREATE VIEW aktivni_projekti_zadaci AS 
SELECT p.naziv AS projekt, p.datum_pocetka AS projekt_pocetak, p.datum_zavrsetka AS projekt_kraj, za.naziv AS zadatak, za.datum_pocetka AS zadatak_pocetak, za.datum_zavrsetka AS zadatak_kraj, za.status AS zadatak_status 
	FROM projekti p 
	LEFT JOIN  zadaci za ON p.id = za.id_projekt 
	WHERE p.status = 'aktivni';

SELECT * FROM aktivni_projekti_zadaci;

-- 4. Pregled troskova sluzbenih putovanja
...
INSERT INTO smjene (id, id_vrsta_smjene, pocetak_smjene, kraj_smjene, min_broj_zaposlenika, id_odjel) 
VALUES (5, 3, '2025-01-10 00:00:00', '2025-01-10 7:00:00', 4, 2);
